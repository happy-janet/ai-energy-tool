...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Add this right after the existing background gradient */}
      <div 
        style={{
          position: 'absolute',
          top: 0,
          ...
          right: 0,
          bottom: 0,
          background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.4), rgba(245, 158, 11, 0.2), rgba(220, 38, 38, 0.2))',
          zIndex: 2,
        ...
        {[...Array(5)].map((_, i) => (
          <div 
            ...
            style={{
              ...
              transform: `translateY(${scrolled * (i % 2 === 0 ? 100 : -100)}px)`,
              transition: 'transform 0.5s ease-out',
              opacity: 0.7
            }}
          />
      ...
      >
        <span style={{ color: 'white', marginBottom: '0.5rem', fontSize: '0.875rem' }}>Scroll to explore</span>
        <div 
          style={{
            width: '30px',
            height: '50px',
